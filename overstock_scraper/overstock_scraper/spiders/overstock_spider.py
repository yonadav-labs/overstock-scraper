...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "overstock_site.settings")
django.setup()

from product.models import *
from product.views import *

class OverstockSpider(scrapy.Spider):
    name = "overstock"

    custom_settings = {
        'USER_AGENT': 'overstock_scraper (+http://www.yourdomain.com)',
    }
    ...
    def store_report(self):
        ...
        path = '/home/exports/overstock-{}-{}.csv'.format(self.task.title, date)
